...
public class DetailFriend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latTextView = (TextView) findViewById(R.id.textView6);
        lngTextView = (TextView) findViewById(R.id.textView7);
        ...
        latTextView.setText(getIntent().getStringExtra("Lat"));
        lngTextView.setText(getIntent().getStringExtra("Lng"));
